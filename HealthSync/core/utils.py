...
svc = pickle.load(open('core/model_files/svc.pkl', 'rb'))

sym_des = pd.read_csv("core/model_files/symtoms_df.csv")
precautions = pd.read_csv("core/model_files/precautions_df.csv")
workout = pd.read_csv("core/model_files/workout_df.csv")
description = pd.read_csv("core/model_files/description.csv")
medications = pd.read_csv('core/model_files/medications.csv')
diets = pd.read_csv("core/model_files/diets.csv")
specialist = pd.read_csv("core/model_files/medical_specialist.csv")
...
def helper(dis):
    ...
    spe = specialist[specialist['Disease'] == dis]['Medical Specialist']
    spe = [spe for spe in spe.values]
    ...
    return desc, pre, med, spe, die, wrkout
